...
function moreAboutHome(address,distanceFromTown,hasNeighbours)
{
    let createManager = {
        Address: address,
        distance: distanceFromTown,
        Neighbours: hasNeighbours
    }

    types = typeof(createManager['Address']) + typeof(createManager['distance']) + typeof(createManager['Neighbours'])
    return types
...
function moreAboutKaren(parents,noOfSiblings,isNuclearFamily)
{
    let moreAboutKaren =
    {
        ...
        nuclear: isNuclearFamily,
    }
    if (typeof moreAboutKaren['parents'] === typeof "" && typeof moreAboutKaren['noofSiblings'] === 'number' && typeof moreAboutKaren['nuclear'] === 'boolean')
    {
        return true
    }
    else {
